...
// pic, name,phone,email,address, course, 
//   school, CGPA, year ,org, des,dur1 ,dur2,employ,workrole, in1,in2,in3 , skill ,strength ,
//    ptitle ,pdesc ,pdate1, pdate2 ,prole, otitle,odesc ,rname ,rdes ,rorg,rphone ,remail)

// ,'$pic', '$name','$phone','$email','$address','$course','$school','$CGPA','$year', '$org',
...
$sql = "insert into employee_application (vid, id) values 
('$vid','$id')";
